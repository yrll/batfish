...
public interface StorageProvider {
  ...
  /**
   * Load the org.batfish.log file for a given work item ID.
   *
   * @throws FileNotFoundException if the org.batfish.log file is not found.
   * @throws IOException if there is an error reading the org.batfish.log file.
   */
  @Nonnull
  ...
  /** Store a given string as a org.batfish.log file for a given work item ID. */
