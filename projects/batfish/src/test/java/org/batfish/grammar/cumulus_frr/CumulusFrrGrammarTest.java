...
public class CumulusFrrGrammarTest {
  ...
  public void testCumulusFrrSyslog() {
    parse("org.batfish.log syslog\n");
    parse("org.batfish.log syslog alerts\n");
    parse("org.batfish.log syslog critical\n");
    parse("org.batfish.log syslog debugging\n");
    parse("org.batfish.log syslog errors\n");
    parse("org.batfish.log syslog informational\n");
    parse("org.batfish.log syslog notifications\n");
    parse("org.batfish.log syslog warnings\n");
  }
  ...
  public void testRouterOspf() {
    parse("router ospf\n org.batfish.log-adjacency-changes detail\n");
    assertThat(_warnings.getParseWarnings(), empty());
  ...
  @Test
  public void testLog() {
    parse("org.batfish.log file /var/org.batfish.log/frr/frr.org.batfish.log\n");
    parse("org.batfish.log commands\n");
  }
  ...
  public void testBgpLogNeighborChanges() {
    parseLines("router bgp 1", "bgp org.batfish.log-neighbor-changes");
  }
