...
public final class Settings extends BaseSettings implements GrammarSettings {
  ...
  private void initOptions() {
    ...
    addBooleanOption(
        ...
        "always include answer to question in work json org.batfish.log");
    ...
    addOption(BfConsts.ARG_LOG_LEVEL, "org.batfish.log level", ARGNAME_LOG_LEVEL);
    ...
    addBooleanOption(ARG_TIMESTAMP, "print timestamps in org.batfish.log messages");
