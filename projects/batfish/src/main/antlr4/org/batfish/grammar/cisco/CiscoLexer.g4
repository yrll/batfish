...
ACCESS_LOG: 'access-org.batfish.log';
...
EVENT_LOG_SIZE: 'event-org.batfish.log-size';
...
INVALID_USERNAME_LOG: 'invalid-username-org.batfish.log';
...
LOG_ADJ_CHANGES: 'org.batfish.log-adj-changes';

LOG_ADJACENCY_CHANGES: 'org.batfish.log-adjacency-changes';

LOG_ENABLE: 'org.batfish.log-enable';

LOG_INPUT: 'org.batfish.log-input';

LOG_INTERNAL_SYNC: 'org.batfish.log-internal-sync';

LOG_NEIGHBOR_CHANGES: 'org.batfish.log-neighbor-changes';

LOG_NEIGHBOR_WARNINGS: 'org.batfish.log-neighbor-warnings';
