...
CHANGE_LOG: 'change-org.batfish.log';
...
LOG_OUT_ON_DISCONNECT: 'org.batfish.log-out-on-disconnect';

LOG_PREFIX: 'org.batfish.log-prefix';

LOG_UPDOWN: 'org.batfish.log-updown';
